 ...
 * @icon fa fa-circle-o
 */
class Command extends Frontend
{
    ...
    public function get_controller_list()
    {
        ...
        $files = new \RecursiveIteratorIterator(new \RecursiveDirectoryIterator($controllerDir), \RecursiveIteratorIterator::LEAVES_ONLY);
        $list = [];
    ...
    public function command($action = '')
    {
        ...
        } else if ($commandtype == 'min') {} else if ($commandtype == 'api') {} else {}
        if ($action == 'execute') {
    ...
    {
        $commandName = "\\app\\index\\command\\" . ucfirst($commandtype);
