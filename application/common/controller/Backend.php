...
class Backend extends Controller
{
    ...
    public function _initialize()
    {
        ...
        $this->assign('operate', $this->wait_opertor());

        // 渲染管理员对象
        $this->assign('admin', Session::get('admin'));
    }

    protected function wait_opertor()
    {
        // 操作人
        $where = [
            'id' => $this->auth->id
    ...
    {
        $this->view->config = array_merge($this->view->config ? $this->view->config : [], is_array($name) ? $name : [
            $name => $value
        ]);
    }
    ...
    protected function getDataLimitAdminIds()
    {
        ...
        if (in_array($this->dataLimit, [
            ...
            $adminIds = $this->dataLimit == 'auth' ? $this->auth->getChildrenAdminIds(true) : [
                $this->auth->id
            ];
        }
        return $adminIds;
