define([ 'jquery', 'bootstrap', 'backend', 'table', 'form' ], function($,
	...
	var Controller = {
		index : function() {
			...
			Table.api.init({
				extend : {
					index_url : 'health/convenience//index'
							+ location.search,
					add_url : 'health/convenience//add',
					edit_url : 'health/convenience//edit',
					del_url : 'health/convenience//del',
					multi_url : 'health/convenience//multi',
